...
gcloud compute instance-groups managed create "$INSTANCE_GROUP_NAME" --size=1 --base-instance-name=gce-runner --template="$TEMPLATE_NAME" --zone=us-west1-b